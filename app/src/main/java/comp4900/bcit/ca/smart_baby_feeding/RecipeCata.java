...
public class RecipeCata extends Fragment {

    public static int sCreatedItems = 0;
    private BoardView mBoardView;
    private int mColumns;

    public static RecipeCata newInstance() { return new RecipeCata();}
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_recipe_cata, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Recipe Catagories");
